...
function useTypingEffect(text, speed = 55, delay = 600) {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0f] text-gray-100 font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#0a0a0f]/90 backdrop-blur-md border-b border-white/5" : "bg-transparent"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-6xl mx-auto px-6 h-16 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl gradient-text cursor-default", children: "KK." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                "data-ocid": `nav.${link.toLowerCase()}.link`,
                onClick: () => scrollTo(link),
                className: `px-4 py-1.5 text-sm rounded-md transition-colors duration-200 ${activeSection === link.toLowerCase() ? "nav-active font-medium" : "text-gray-400 hover:text-gray-100"}`,
                children: link
              }
            ) }, link)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-[#0a0a0f]/95 backdrop-blur-md border-b border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "flex flex-col px-4 py-3 gap-1", children: [
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/8 rounded-full blur-3xl" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-1/4 right-1/4 w-80 h-80 bg-purple-600/8 rounded-full blur-3xl" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fade-in delay-100 text-blue-400 text-sm font-medium mb-4 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-6 h-px bg-blue-400" }),
                "Salutations, Recruiter 👋"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "fade-in delay-200 font-display text-5xl sm:text-6xl font-bold leading-tight mb-2", children: "Kartik" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "fade-in delay-300 font-display text-5xl sm:text-6xl font-bold leading-tight mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text glow-blue", children: "Kamate" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fade-in delay-400 text-gray-400 text-base sm:text-lg leading-relaxed mb-2 min-h-[3rem]", children: [
                displayed,
                !done && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-0.5 h-4 bg-blue-400 ml-0.5 animate-pulse" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "fade-in delay-500 text-gray-500 text-sm mb-8 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5" }),
                " Nipani, Karnataka · CSE 2026"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in delay-500 mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs uppercase tracking-widest mb-3", children: "Current tech focus" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: TECH_STACK.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in delay-600 flex flex-wrap gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in delay-600 flex gap-3 mt-6", children: [
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center md:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fade-in delay-300 relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "photo-ring", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-3 -left-4 bg-[#0f0f1a] border border-white/10 rounded-xl px-3 py-2 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-300 font-medium", children: "Open to opportunities" })
              ] })
            ] }) })
          ] })
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "about", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "About Me", title: "Who I am" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-12 items-start mt-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-gray-400 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "I'm a",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-medium", children: "Computer Science Engineering" }),
            " ",
            "student specializing in",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 font-medium", children: "Java Backend Development" }),
            ". Experienced in building scalable RESTful APIs using Spring Boot and integrating MySQL databases."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Passionate about writing clean, maintainable code and solving real-world problems using efficient system design principles. Currently pursuing BE at Sri Sairam College of Engineering." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 space-y-3", children: [
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 text-blue-400" }),
              val: "kartikkamate00@gmail.com"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 text-purple-400" }),
              val: "7259720546"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-pink-400" }),
              val: "Nipani, Karnataka"
            }
          ].map(({ icon, val }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 text-sm", children: [
            icon,
        ...
        ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-hover rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-display font-bold gradient-text mb-1", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-white", children: s.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 mt-0.5", children: s.sub })
        ] }, s.label)) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "experience", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Work", title: "Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ExperienceCard,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "projects", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Work", title: "Featured Projects" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid md:grid-cols-3 gap-6", children: PROJECTS.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project: p, index: i + 1 }, p.title)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "skills", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Tools", title: "Skills & Technologies" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mt-2 max-w-xl", children: "A backend-focused engineer with hands-on experience across the Java ecosystem, databases, and web fundamentals." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: SKILLS.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkillGroup, { group: g }, g.category)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "education", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-6 py-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Study", title: "Education" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-hover rounded-xl p-6 mt-8 flex gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "w-5 h-5 text-blue-400" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-semibold", children: "Sri Sairam College of Engineering" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm mt-1", children: "BE – Computer Science Engineering" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2.5 py-0.5 rounded-full bg-blue-500/10 text-blue-400 border border-blue-500/20", children: "CSE 2026" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-2.5 py-0.5 rounded-full bg-green-500/10 text-green-400 border border-green-500/20", children: "CGPA 8.34" })
              ] })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Credentials", title: "Certifications" }),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "w-4 h-4", style: { color: c.color } })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-white", children: c.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Recognition", title: "Achievements" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4 mt-8", children: [
          {
            title: "5 Star Java",
            platform: "HackerRank",
            stars: 5,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-5 h-5", style: { color: a.color } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold text-sm", children: a.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mt-1", children: ["s1", "s2", "s3", "s4", "s5"].map(
                  (sk, si) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Star,
                    {
                      className: "w-3 h-3",
                      style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500 mt-0.5", children: a.platform })
              ] })
            ]
          },
          a.title
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("hr", { className: "section-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RevealSection, { id: "contact", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 py-24 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { label: "Reach out", title: "Get in Touch", centered: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mt-3 mb-10", children: "Currently open to backend engineering roles and internship opportunities. Feel free to drop me a message." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4 text-left", children: [
        {
        ...
        "a",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500", children: c.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-white", children: c.value })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-3.5 h-3.5 text-gray-600 ml-auto group-hover:text-gray-300 transition-colors" })
          ]
        },
        c.label
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-white/5 py-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold gradient-text", children: "KK." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-6 text-xs text-gray-600", children: NAV_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollTo(l),
        ...
        ].map(({ href, icon }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            target: "_blank",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-700 mt-6", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Kartik Vishnu Kamate. Built with",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
...
function SectionHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: centered ? "text-center" : "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400 text-xs font-semibold uppercase tracking-widest mb-2", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl sm:text-4xl font-bold text-white", children: title })
  ] });
}
function ExperienceCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-hover rounded-xl p-6 relative pl-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-8 -translate-x-1/2 w-3 h-3 rounded-full timeline-dot" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-semibold", children: jobTitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-3.5 h-3.5 text-blue-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-400 text-sm", children: company })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs px-3 py-1 rounded-full bg-white/5 border border-white/8 text-gray-400", children: period })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2.5 text-sm text-gray-400", children: [
...
function ProjectCard({
  ...
  const color = COLORS[(index2 - 1) % COLORS.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      "data-ocid": `projects.item.${index2}`,
      style: {
        transitionDelay: `${(index2 - 1) * 100}ms`,
        borderTopColor: visible ? color : "transparent"
      },
      className: `card-hover rounded-xl p-6 flex flex-col transition-all duration-500 border-t-2 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-white font-semibold mb-2", children: project.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs leading-relaxed mb-4", children: project.desc }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-5", children: project.tech.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5 flex-1 mb-5", children: project.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-xs text-gray-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            "data-ocid": `projects.github.link.${index2}`,
            href: "https://github.com",
            target: "_blank",
            rel: "noreferrer",
...
function SkillGroup({ group }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `card-hover rounded-xl p-5 transition-all duration-500 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-md bg-blue-500/10 flex items-center justify-center text-blue-400", children: group.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: group.category })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: group.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
